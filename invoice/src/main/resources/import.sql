INSERT INTO INVOICE (ORDER_NUMBER,ID_CUSTOMER) VALUES('AA123456789A',1),('AA123456789B',1),('BB123456789A',2),(NULL,3);
...
(1,5,(select INVOICE_NUMBER from INVOICE where ORDER_NUMBER is NULL));